...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const infoTexts = {
    unicorn:
      "<ul><h3>Einhorn auf dem Rücken eines Mannes</h3><br><li>Gips,1926</li><br><li>Originalstein noch am Münster</li></ul>",
    manWithBook:
      "<ul><h3>Mann mit Buch</h3><br><li>Steinkopie, 1913</li><br><li>Original nicht vollständig erhalten. Bei Kopie 2005 erneut leicht verändert</li></ul>",
    dog: "<ul><h3>Hund</h3><br><li>Originalstein, um 1260/70</li></ul>",
    horses: "<ul><h3>Pferd</h3><br><li>Originalstein, um 1250</li></ul>",
    fantasyDog:
      "<ul><h3>Hundeähnliches Fantasiewesen</h3><br><li>Steinkopie/Originalstein, Körper: unbekannt, Klauen und Beute: 1. Hälfte 16. Jh.</li><br><li>Modell zeigt den Zustand bis 1998 mit einem nicht datierten Körper und einem Rest des nicht vollständig erhaltenen Originals. Bei der Kopie wurde auf die Zusammenstellung verzichtet und nur der neue Teil übernommen</li></ul>",
    dogWithFeather:
      "<ul><h3>Hundeähnliches Wesen mit Vogelfedern</h3><br><li>Originalstein, 1. H.16.Jh.</li></ul>",
    monsterdog:
      "<ul><h3>Monsterhund</h3><br><li>Originalstein, 1. H.16.Jh.</li></ul>",
    zanner:
      "<ul><h3>Akrobat 'Zanner'</h3><br><li>Originalstein, 1. H.16.Jh.</li></ul>",
    skeletonHuman:
      "<ul><h3>Skelettierter Mensch</h3><br><li>Originalstein, Körper: 1. H. 16. Jh., Kopf: später</li><br><li>Bei der Kopie 1939 wurde der Kopf verändert</li></ul>",
    dogWithRabbit:
      "<ul><h3>Hund mit erbeutetem Hasen</h3><br><li>Originalstein, 1. H.16. Jh.</li></ul>",
    griffin:
      "<ul><h3>Greif</h3><br><li>Originalstein, 1. H.16. Jh.</li><br><li>Kopf später angefügt</li></ul>",
    ...
    billyGoat:
      "<ul><h3>Ziegenbock</h3><br><li>Originalstein, um 1270</li></ul>",
    manWithJug:
      "<ul><h3>Mann mit Krug und Kapuzenmantel</h3><br><li>Gips, 1914</li><br><li>Originalstein noch am Münster</li></ul>",
    knight:
      "<ul><h3>Ritter 'Hochmut'</h3><br><li>Gips, 1914</li><br><li>Original im Augustinermuseum</li></ul>",
